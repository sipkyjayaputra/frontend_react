...
const routes = [
  ...
  { path: "/post", name: "Post", component: AllPosts, exact: true },
  { path: "/post/all", name: "All Post", component: AllPosts },
  { path: "/post/new", name: "Add New Post", component: AddNew },
  { path: "/post/preview", name: "Preview", component: preview },
  { path: "/post/:id", name: "Edit Post", component: EditPost },
